...
requirements = python3, kivy==2.3.1, carbonkivy==0.0.3, android, pyjnius
...
presplash.filename = %(source.dir)s/assets/images/carbonkivy_banner1024.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assets/images/carbonkivy_logo512.png
